      ...
      <div className="md:w-1/2">
        ...
        <div className="md:w-1/2 space-y-7">
          ...
          <p className="text-xl text-[#4A4A4A]">
            Where Each Plate Weaves a Story of Culinary Mastery ans Passionate
            Craftsmanship
          </p>
